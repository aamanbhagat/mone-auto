        ...
        if page_height > viewport_height:
            ...
            for session in range(scroll_sessions):
                ...
                if not link_clicked and current_time >= link_click_time:
                    state.current_step = "looking for clickable links"
                    try:
                        # Find all clickable links on the page
                        all_links = await page.query_selector_all('a[href]')
                        # Filter out internal anchors, javascript, and unwanted links
                        valid_links = []
                        ...
                        if valid_links:
                            ...
                            if box:
                                ...
                                state.current_step = "clicked random link - waiting for new page"
                                results.append(StepResult("Clicked Random Link", "OK", "Human-like click behavior"))
                            ...
                            state.current_step = "no clickable links found - continuing reading"
            ...
            # Try to click a random link after reading
            state.current_step = "looking for clickable links"
            try:
                # Find all clickable links on the page
                all_links = await page.query_selector_all('a[href]')
                ...
                if valid_links:
                    ...
                    results.append(StepResult("Human Reading", "OK", "Read short page content - no clickable links found"))
            except Exception:
